...
public class Buffer implements ArrayAccess, Countable, Gettable {
  ...
  public Buffer(Env env, Value value) {
    buffer = io.vertx.core.buffer.Buffer.buffer(value.toString());
  }
  ...
  public Buffer append(Env env, Value value) {
    if (value.isLong()) {
      ...
      buffer.appendBuffer((io.vertx.core.buffer.Buffer) value.toJavaObject(env, io.vertx.core.buffer.Buffer.class));
    }
    return this;
  }
  ...
  public io.vertx.core.buffer.Buffer __toVertxBuffer() {
    return buffer;
  }
